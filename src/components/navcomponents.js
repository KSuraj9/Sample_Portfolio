...
export function Home(){
    return(
        <section style={{padding:"10px 0px",backgroundColor: "rgba(26, 194, 250, 0.764)", height:'800px'}} id="Home">
                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I am Suraj Kumar</h1>
                            <p>This is my portfolio website</p>
                            <p>As a college student, my personality is characterized by a strong willingness to learn, 
a passion for personal and professional growth, and a dedication to excellence in all 
that I do. <i className="bi bi-search"></i></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="intro" className='mt-2'>
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)", height:'600px', width:'1000px'}}>
                        <h1>
                            <div class="display-4">Suraj Kumar 
                            <span class="tt" data-bs-placement="bottom" title="" style={{margin:'50px'}}>
                        ...
                        <hr />
                        <div class="contact" >
                            <p class="lead pt-0">Im currently learning Machine Learning, Cloud computing and MERN-Stack</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to contact me : 
                                <a href="mailto:contactsuraj6299@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            ...
                            <p class="btn-group" >
                                <a href="https://www.linkedin.com/in/suraj-kumar-42babb236/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://www.linkedin.com/in/suraj-kumar-42babb236/" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                            </p>
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/KSuraj9" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
